...
const Card = () => {
  ...
  return (
    <div className="dashboard-wrapper">
      ...
      <ReactTooltip id="tt-pattern" place="top" className="custom-tooltip" portalSelect="body">
        <div>[주거 지수] (출근 승차 수 + 퇴근 하차 수) / 전체</div>
        <div>[업무 지수] (출근 하차 수 + 퇴근 승차 수) / 전체</div>
        <div>[여가 지수] (평일 오후 하차 수 + 주말 하차 수) / 전체</div>
      </ReactTooltip>

      <ReactTooltip id="tt-norm" place="top" className="custom-tooltip" portalSelect="body">
